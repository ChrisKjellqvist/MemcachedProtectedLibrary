...
memcached$(EXEEXT): $(memcached_OBJECTS) $(memcached_DEPENDENCIES) $(EXTRA_memcached_DEPENDENCIES) 
	...
	$(AM_V_CC)$(COMPILE) -c $(CFLAGS) plib.c testapp.c pku_memcached.c 
	ld -r testapp.o pku_memcached.o -o user_prg.o
	$(AM_V_CC)$(COMPILE) -c $(CFLAGS) init.c
	ld -r -o prot.o $(memcached_OBJECTS) $(memcached_LDADD) 
	clang -WT ldscript.lds $(CFLAGS) -o memcached -levent init.o user_prg.o prot.o
