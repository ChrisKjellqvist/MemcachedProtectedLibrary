...
#define CACHE_LINE_MASK LEVEL1_DCACHE_LINEMASK
...
// class barrier{
// 	int target; // immutable.
// 	std::atomic<int> waiting;
// 	std::atomic<int> curr_bar;
// 	bool inited = false;
// public:
// 	barrier(int t){
// 		init(t);
...
// 	void init(int t){
// 		target = t;
// 		waiting.store(target);
// 		inited = true;
// 	}
// 	void hit() {
// 		assert(inited);
// 		int empty = 0;
// 		int bar_snap = curr_bar.load();
// 		waiting.fetch_add(-1);
// 		if(waiting.compare_exchange_strong(empty, target)){
// 			curr_bar.fetch_add(1);
// 		} else {
// 			while(curr_bar.load() == bar_snap);
// 		}
// 	}
// };
